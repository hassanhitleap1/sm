...
class CouponsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view($this->view_path.'index', ['setup' => [
            ...
            'items'=>$this->getRestaurant()->coupons()->paginate(env('PAGINATE',10)),
    ...
    public function apply(Request $request)
    {
        ...
        else if((new Carbon($coupon->active_from))->eq(new Carbon($coupon->active_to)) && (new Carbon(Carbon::now()->toDateString()))->eq(new Carbon($coupon->active_from)) && (new Carbon(Carbon::now()->toDateString()))->eq(new Carbon($coupon->active_to))){
            $dateActive = true;
        }
        ...
        }else if($coupon->type == 1 && $coupon->limit_to_num_uses > 0 && $dateActive){
