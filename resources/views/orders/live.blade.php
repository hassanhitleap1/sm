    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-md-12 {{ $class ?? '' }}">
                <h1 style="display:inline"  class="display-2 text-white">{{ __("qrlanding.live_orders") }}</h1>
    ...
    <div id="liveorders" class="row">
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <!-- Title -->
              <h5 class="h3 mb-0">{{ __('qrlanding.new-orders')}}</h5>
            </div>
            <!-- Card body -->
            <div class="card-body">
              <!-- List group -->
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0">{{ __('qrlanding.accepted')}}</h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0">{{ __('qrlanding.done')}}</h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
