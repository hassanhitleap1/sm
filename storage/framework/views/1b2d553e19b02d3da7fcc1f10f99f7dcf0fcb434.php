<?php $__env->startSection('admin_title'); ?>
    <?php echo e(__('qrlanding.orders')); ?>
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="modal-title-new-item"><?php echo e(__('qrlanding.assign-driver')); ?></h3>
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            <form id="form-assing-driver" method="GET" action="">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary my-4"><?php echo e(__('qrlanding.save')); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', ['title' => __('qrlanding.orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurant-menus\resources\views/orders/index.blade.php ENDPATH**/ ?>