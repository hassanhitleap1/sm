...
<?php $__env->startSection('admin_title'); ?>
    <?php echo e(__('qrlanding.live_orders')); ?>
    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-md-12 <?php echo e($class ?? ''); ?>">
                <h1 style="display:inline"  class="display-2 text-white"><?php echo e(__("qrlanding.live_orders")); ?></h1>
    ...
    <div id="liveorders" class="row">
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <!-- Title -->
              <h5 class="h3 mb-0"><?php echo e(__('qrlanding.new-orders')); ?></h5>
            </div>
            <!-- Card body -->
            <div class="card-body">
              <!-- List group -->
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0"><?php echo e(__('qrlanding.accepted')); ?></h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0"><?php echo e(__('qrlanding.done')); ?></h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
...
<?php echo $__env->make('layouts.app', ['title' => __('qrlanding.orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurant-menus\resources\views/orders/live.blade.php ENDPATH**/ ?>