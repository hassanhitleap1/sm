    ...
    <div class="card  bg-secondary shadow">
        <div class="card-header border-0">
            <div class="row align-items-center">
                <div class="col-8">
                    <h3 class="mb-0"><?php echo e(__('qrlanding..fee-information')); ?></h3>
                </div>
        ...
        <div class="card-body">
            <p>
                ...
                <?php echo e(__('Your current percentage fee on each order is:').' '.$restaurant->fee."% ".__('qrlanding.on-the-order-value')); ?> <br />
                <hr />
...
<?php /**PATH C:\xampp\htdocs\restaurant-menus\resources\views/finances/feeterms.blade.php ENDPATH**/ ?>